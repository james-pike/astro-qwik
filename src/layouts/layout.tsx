    ...
    <>
      ...
      <div class='relative'>
        ...
        <div class='max-w-8xl pt-[72px] mx-auto px-4 sm:px-6 md:px-8 '>
          <div
            id='sidebar'
            class={`lg:block fixed inset-0 top-[73px] transition-all duration-300 right-auto w-[14.5rem] bg-gradient-to-r from-blue-100 to-slate-200 py-4 px-6 overflow-y-auto border-r border-brand-outline bg-brand-background lg:left-[max(0px,calc(50%-45rem))] z-20 ${
            ...
            <div class='relative'>
              <ul class='flex flex-col gap-2 m-0 p-0 pt-4 list-none'>
                ...
                {siteLinks.map((item, index) => {
                  ...
                  return (
                    <li key={index} class='m-0 p-0 text-xl'>
                      <NavLink
                        title={title}
                        icon={icon}
                        stroke={stroke}
